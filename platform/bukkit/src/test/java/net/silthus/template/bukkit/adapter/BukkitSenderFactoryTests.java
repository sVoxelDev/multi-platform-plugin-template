...
import net.silthus.template.bukkit.BukkitTests;
...
class BukkitSenderFactoryTests extends BukkitTests {
    ...
    class wrap {
        ...
        @Nested
        class given_player_display_name_changes {
            @BeforeEach
            void setUp() {
        ...
        @Nested
        class given_formatted_player_display_name {
            @BeforeEach
            void setUp() {
        ...
        @Nested
        class given_player_with_no_permissions {
            @Test
        ...
        @Nested
        class when_sendMessage_is_called {
            @BeforeEach
            void setUp() {
        ...
        class given_console_sender {
            ...
            void then_uses_console_properties() {
                assertThat(console.getIdentity()).isEqualTo(Sender.CONSOLE);
            }
